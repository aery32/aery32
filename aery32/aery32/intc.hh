...
static inline void intc_register_isrhandler(void (*)(void) handler,
		uint32_t group, uint8_t priority)
{
	aery_intc_register_isrhandler(handler, group, priority);
}

static inline void intc_enable_globally(void)
{
	aery_intc_enable_globally();
}

static inline void intc_disable_globally(void)
{
